...
Frequency
    ...
    <h5 className="mt-4">
      <i className="im im-check-mark mr-2" />
      {' '}
Safe Threshold
    </h5>
    <p className="card-text">
...
Danger Threshold
    ...
    <p className="card-text">
      ...
      {' '}
      <br />
- These values will turn red and require actions
    </p>
  </div>
);
